...
import { addItem, clearItems, minusItem, removeItem } from '../components/redux/Cart/slice';
...
const CartItemBlock: React.FC<CartItemProps> = ({ id, name, type, price, count, imageUrl, size }) => {
  ...
  const onClickRemove = () => {
    if (totalCount > 0) {
      if (window.confirm('Are you sure want to remove the tastest pizza ???')) {
